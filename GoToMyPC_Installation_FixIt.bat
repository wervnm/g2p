...
@echo installation problems.  It leaves host
@echo registration info intact.
@echo ****************************************
@echo.
:menu
echo.
...
echo.
echo 1. Run GoToMyPC Installation FixIt
echo 2. Quit
echo.
...
reg delete "HKEY_CLASSES_ROOT\Installer\Products\416608FA54A38E246A9F79C100A57675"
reg delete "HKEY_CLASSES_ROOT\Installer\Features\416608FA54A38E246A9F79C100A57675"
...
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Installer\UserData\S-1-5-18\Components\029A701D10F7A17409A270CC818BFB6C" /f >nul 2>nul
...
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DIFx\Services\monblanking" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DIFx\DriverStore\monblankin_65D49A5B903FBF9D8470BFE87DC09BF4DB247C8B" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DIFxApp\Components\{D2C1C66F-9EB2-460D-B902-B6FB3E3F9F46}" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\B55781558C6FAB4237DDEE317F2409086B83E855" /f >nul 2>nul
