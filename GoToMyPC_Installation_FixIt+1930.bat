...
echo  1930 install log-autoupgrade >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo =======================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo[
type "%systemroot%\Temp\G2_1930\GoToMyPC_Installation.log" >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo =============================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo =======================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
...
echo =======================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo  1930 install log-user upgrade >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo =======================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo[
type "%Temp%\G2_1930\GoToMyPC_Installation.log" >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
echo =======================  >> "%userprofile%\Desktop\GoToMyPC_Installer_Log.txt" 2>nul
...
@echo *                                      *
@echo * Supports  v9.2 b 1930 or lower       *
@echo ****************************************
@echo ****************************************
...
rem keys for build 1930
reg delete "HKEY_CLASSES_ROOT\Installer\Products\E17B187BDB874184EA9E308BF1083004" /f >nul 2>nul
reg delete "HKEY_CLASSES_ROOT\Installer\Features\E17B187BDB874184EA9E308BF1083004" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Installer\Products\E17B187BDB874184EA9E308BF1083004" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Installer\Features\E17B187BDB874184EA9E308BF1083004" /f >nul 2>nul4
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Installer\UserData\S-1-5-18\Products\E17B187BDB874184EA9E308BF1083004" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{B781B71E-78BD-4814-AEE9-03B81F800340}" /f >nul 2>nul
...
del "%programfiles(x86)%\Citrix\GoToMyPC\" /f /q >nul 2>nul
 ...
 rem monblanking files
del "%systemroot%\System32\drivers\monblanking.sys" /f /q >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DIFx\DriverStore\monblankin_08936B884C1597DB0C203D5078AF62A9120400EF"
...
rem keys for b1930 x64
reg delete "HKEY_CLASSES_ROOT\Installer\Products\CC6242E5AF28C3540BE7556828F5D2C8" /f >nul 2>nul
reg delete "HKEY_CLASSES_ROOT\Installer\Features\CC6242E5AF28C3540BE7556828F5D2C8" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Installer\Products\CC6242E5AF28C3540BE7556828F5D2C8" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Installer\Features\CC6242E5AF28C3540BE7556828F5D2C8" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Installer\UserData\S-1-5-18\Products\CC6242E5AF28C3540BE7556828F5D2C8" /f >nul 2>nul
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{5E2426CC-82FA-453C-B07E-5586825F2D8C}" /f >nul 2>nul


rem keys for b1875
reg delete "HKEY_CLASSES_ROOT\Installer\Products\252521373375D304291B02BB90E1F2E8" /f >nul 2>nul
